...
func (mockVerifier) VerifySeal(proof minertypes.SealVerifyInfo) (bool, error) {
...
func (mockVerifier) VerifyAggregateSeals(aggregate minertypes.AggregateSealVerifyProofAndInfos) (bool, error) {
...
// TODO: do the thing
func (mockVerifier) VerifyReplicaUpdate(update minertypes.ReplicaUpdateInfo) (bool, error) {
	return false, nil
}

func (mockVerifier) VerifyWinningPoSt(ctx context.Context, info minertypes.WinningPoStVerifyInfo) (bool, error) {
	panic("should not be called")
}
func (mockVerifier) VerifyWindowPoSt(ctx context.Context, info minertypes.WindowPoStVerifyInfo) (bool, error) {
