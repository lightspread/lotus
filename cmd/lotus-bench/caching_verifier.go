...
func (cv *cachingVerifier) VerifySeal(svi minertypes.SealVerifyInfo) (bool, error) {
	return cv.withCache(func() (bool, error) {
		return cv.backend.VerifySeal(svi)
	}, &svi)
}

func (cv *cachingVerifier) VerifyWinningPoSt(ctx context.Context, info minertypes.WinningPoStVerifyInfo) (bool, error) {
	return cv.backend.VerifyWinningPoSt(ctx, info)
}

func (cv *cachingVerifier) VerifyWindowPoSt(ctx context.Context, info minertypes.WindowPoStVerifyInfo) (bool, error) {
	return cv.withCache(func() (bool, error) {
...
func (cv cachingVerifier) VerifyAggregateSeals(aggregate minertypes.AggregateSealVerifyProofAndInfos) (bool, error) {
	return cv.backend.VerifyAggregateSeals(aggregate)
}

func (cv cachingVerifier) VerifyReplicaUpdate(update minertypes.ReplicaUpdateInfo) (bool, error) {
