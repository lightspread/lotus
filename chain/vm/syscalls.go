...
func (ss *syscallShim) VerifyConsensusFault(a, b, extra []byte) (*runtime7.ConsensusFault, error) {
	...
	if blockA.Height == blockB.Height {
		consensusFault = &runtime7.ConsensusFault{
			Target: blockA.Miner,
			Epoch:  blockB.Height,
			Type:   runtime.ConsensusFaultType(runtime7.ConsensusFaultDoubleForkMining),
		}
	}
	...
	if types.CidArrsEqual(blockA.Parents, blockB.Parents) && blockA.Height != blockB.Height {
		consensusFault = &runtime7.ConsensusFault{
			Target: blockA.Miner,
			Epoch:  blockB.Height,
			Type:   runtime.ConsensusFaultType(runtime7.ConsensusFaultTimeOffsetMining),
		}
	}
	...
	if len(extra) > 0 {
		...
		if types.CidArrsEqual(blockA.Parents, blockC.Parents) && blockA.Height == blockC.Height &&
			...
			consensusFault = &runtime7.ConsensusFault{
				Target: blockA.Miner,
				Epoch:  blockB.Height,
				Type:   runtime.ConsensusFaultType(runtime7.ConsensusFaultParentGrinding),
			}
		}
	}
